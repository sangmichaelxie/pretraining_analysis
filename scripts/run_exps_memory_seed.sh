...
NUM_EXAMPLES=5000
START_TEMP=10.0
DATASET=memoryhmm_trans${TRANS_TEMP}_emit${EMISSION_TEMP}_start${START_TEMP}_nexamples${NUM_EXAMPLES}_nsymbols${N_SYMBOLS}_nmemslots${N_MEM_SLOTS}_nhidden${N_HIDDEN_STATES}_seed${SEED}
EPOCHS=3
BATCH_SIZE=8
